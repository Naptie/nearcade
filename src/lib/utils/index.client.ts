 ...
 *
 * This is an intentional anti-pattern: a name match is instant, synchronous,
 * and catches every GPU class worth running the globe on.  The post-mount
 * rAF sampler is the actual quality gate for GPUs that pass the name check
 * but are still too slow.
 */
