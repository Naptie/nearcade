...
export default defineOpenApiRoute({
  get: {
    ...
    description: bilingual('获取原点附近的店铺，可选择是否包含在勤人数和计算得出的营业时间信息。', 'Find shops near an origin point, optionally including attendance and computed opening-time information.'),
    requestParams: {
      query: discoverQuerySchema
    },
    responses: {
      '200': jsonResponse(bilingual('附近店铺', 'Nearby shops', true), discoverResponseOpenApiSchema),
